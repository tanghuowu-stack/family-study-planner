...
function TaskRow({ task, periods, selected, onToggle, onCopy, onEdit, onDelete, sortable }: Props & { task: Task; periods: PlanPeriod[]; selected: boolean; onToggle: () => void; sortable?: boolean }) {
