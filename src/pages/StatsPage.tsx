...
export function StatsPage({ onImported, cloudMode, onAuthChange }: { onImported: () => void; cloudMode?: boolean; onAuthChange?: () => void | Promise<void> }) {
